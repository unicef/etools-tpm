...
module.exports = function() {
    return project.splitSource()
        .pipe(gulpif('**/*.js', babel({presets: ['es2015', 'es2017']})))
        ...
        .pipe(gulpif(function(file) {
            ...
            compileHtmlTags('script', function (tag, data) { return data.pipe(babel({presets: ["es2015-without-strict", 'es2017']})).pipe(minifyJs()); }),
            minifyHtml()
        )))
